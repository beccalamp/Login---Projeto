...
{
    private readonly int tempoMaximo = 30;
    ...
    private void BotaoBuscarImagem(object sender, RoutedEventArgs e)
    {
        ...
        switch (nomeEstudante.ToLower())
        {
            case "rebecca":
                ...
                ImagemAluna.Source =
                    CriarImagem(
                        "https://i.ytimg.com/vi/QVCZOzcEj2M/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLA74vLu7dUbvH6dac3G7GShJknwOw");
                break;
            ...
            case "joyce":
                ...
                ImagemAluna.Source =
                    CriarImagem(
                        "https://img2.lovecell.com.br/af9a6462d73cc6686fba709b7ee510ffa905d4b566f863801a0659c13f081351.webp");
                break;
            ...
            case "adrielly":
                ...
                ImagemAluna.Source =
                    CriarImagem(
                        "https://observatoriodocinema.com.br/wp-content/uploads/2021/05/Meowth_Team_Rocket.jpg");
                break;
            ...
            case "rebeca":
                ...
                ImagemAluna.Source =
                    CriarImagem(
                        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTqLv2PNgQR7nj8n1l_99K5hUhGjQNfgFtLEQ&s");
                break;
